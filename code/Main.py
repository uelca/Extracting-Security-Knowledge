...
def main() -> object:
    ...
    query_Control_Type = "Du sollst im folgenden als Sicherheitsexperte agieren. Ich werde dir nun eine Maßnahme geben und möchte von dir, dass du mir mitteilst, um was für eine Maßnahme es sich handelt. Es gibt vier mögliche Arten von Maßnahmen: abschreckende, korrigierende, vorbeugende, Wiederherstellungs- oder Aufdeckungsmaßnahmen. Deine Antwort soll wie folgt aufgebaut sein: Bezeichner der Maßnahme - Art der Maßnahme. Es soll keine weitere Erklärung oder Erläuterung in deiner Antwort vorkommen. Eine Beispielantwort: APP.1.1.A2 Einschränken von Aktiven Inhalten ist Vorbeugend. Hier ist die Maßnahme: "
